...
Este script Python automatiza a coleta de dados de Fundos de Investimento Imobiliário (FIIs) do site fiis.com.br, processando e organizando as informações em um formato facilmente analisável.

**Descrição:**
O script utiliza web scraping para extrair dados detalhados sobre FIIs de uma fonte confiável, processa essas informações e as exporta para um arquivo Excel, facilitando análises posteriores.
...
- Chrome WebDriver (para o Coletor de Dados de FIIs)
